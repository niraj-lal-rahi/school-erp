    ...
    */
    ...
    'connections' => [
        ...
        'platform' => [
            ...
            'database' => env('PLATFORM_DB_DATABASE', 'erp_platform'),
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                (PHP_VERSION_ID >= 80500 ? Mysql::ATTR_SSL_CA : PDO::MYSQL_ATTR_SSL_CA) => env('PLATFORM_MYSQL_ATTR_SSL_CA', env('MYSQL_ATTR_SSL_CA')),
            ]) : [],
        ],
