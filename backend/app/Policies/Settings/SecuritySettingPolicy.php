...
class SecuritySettingPolicy
{
    ...
    {
        return $this->inScope($user, $securitySetting->school_id) && $this->canView($user);
    }

    public function update(User $user, SecuritySetting $securitySetting): bool
    {
        return $this->inScope($user, $securitySetting->school_id) && $this->canManage($user);
    }

    public function updateScope(User $user, ?int $schoolId): bool
    {
        return $this->inScope($user, $schoolId) && $this->canManage($user);
    }
