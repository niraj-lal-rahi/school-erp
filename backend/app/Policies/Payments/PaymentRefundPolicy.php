...
class PaymentRefundPolicy
{
    ...
    public function view(User $user, PaymentRefund $refund): bool
    {
        return $this->sameTenant($user, $refund->school_id) && $this->isFinanceOperator($user);
    }
    ...
    public function process(User $user, PaymentRefund $refund): bool
    {
        return $this->sameTenant($user, $refund->school_id) && $this->isFinanceOperator($user);
    }
