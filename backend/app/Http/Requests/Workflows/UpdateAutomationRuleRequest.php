...
class UpdateAutomationRuleRequest extends WorkflowRequest
{
    public function rules(): array
    {
        return [
            'name' => ['sometimes', 'string', 'max:255'],
            'code' => ['sometimes', 'string', 'max:100', $this->uniqueInTenant('automation_rules', 'code', $this->routeModelId('id'))],
            'module' => ['sometimes', 'string', Rule::in($this->moduleOptionsForAutomation())],
            'trigger_type' => ['sometimes', 'string', Rule::in(['event', 'schedule', 'condition'])],
            ...
            'actions' => ['sometimes', 'array', 'min:1', $this->validActions()],
