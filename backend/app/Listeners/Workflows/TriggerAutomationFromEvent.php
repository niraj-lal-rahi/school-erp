...
class TriggerAutomationFromEvent implements ShouldQueue
{
    ...
    public function handle(object $event): void
    {
        ...
        $this->triggers->triggerMatchingAutomations($eventName, $payload);
    }
        ...
        return match (true) {
            $event instanceof StudentCreated => [
                ...
                [
                    ...
                    'idempotency_key' => 'student-created-'.$event->student->id,
                ],
            ],
            $event instanceof InvoicePaid => [
                ...
                [
                    ...
                    'idempotency_key' => 'invoice-paid-'.$event->invoice->id,
                ],
            ],
            $event instanceof StudentAttendanceSessionSubmitted => [
                ...
                [
                    ...
                    'idempotency_key' => 'attendance-submitted-'.$event->session->id,
                ],
            ],
            $event instanceof ResultsPublished => [
                ...
                [
                    ...
                    'idempotency_key' => 'results-published-'.$event->publication->id,
                ],
            ],
            $event instanceof AnnouncementPublished => [
                ...
                [
                    ...
                    'idempotency_key' => 'announcement-published-'.$event->announcement->id,
                ],
            ],
            default => [null, []],
        };
