...
Route::prefix('v1/tenant')->group(function (): void {
    ...
    Route::middleware(['auth:api', 'resolve.tenant', 'switch.tenant.database', 'tenant.active', 'emergency.access', 'api.rate:api'])->group(function (): void {
        ...
        if (file_exists(base_path('app/Modules/Tenant/routes.php'))) {
            require base_path('app/Modules/Tenant/routes.php');
        }
    });
});
